                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="company-detail bg-dark margin-left">
                                                ...
                                                <form class="login" method="post" action='{{route("auth.handleLogin")}}'>
                                                    @csrf
                                                ...
                                                <a  href='{{route('auth.github.redirect')}}' class="button btn btn-warning">LogIn with GetHub</a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="company-detail new-account bg-light margin-right">
                                                ...
                                                <form class="login" method="post" action='{{route("auth.handelRegister")}}'>
                                                    @csrf
                                                    ...
                                                    <p class="form-row input-required">
                                                        ...
                                                        <input type="email" id="email1" name="email" class="input-text">
                                                    </p>
                                                    <p class="form-row input-required">
                                                        <label>
                                                            <span class="first-letter">Password</span>
                                                ...
                                                <a href='{{route('auth.github.redirect')}}' class="button btn btn-default">Sign up with GetHub</a>
